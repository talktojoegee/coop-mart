...
namespace Modules\CoopSavings\Processor;
...
use Modules\CoopSavings\Response\PaystackResponse;

class CoopSavingsProcessor implements PaymentProcessorInterface, RequiresCallbackInterface
{
    ...
    private function setupData()
    {
        ...
        $this->paystack = CoopSavings::firstWhere('alias', config('paystack.alias'))->data;
    }
