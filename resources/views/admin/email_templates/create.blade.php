                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                @if($languages->isNotEmpty())
                                                    ...
                                                    <div class="card-header p-0">
                                                        <img src='{{ asset("datta-able/fonts/flag/flags/4x3/". getSVGFlag($language->short_name) .".svg") }}' height="20" alt="{{ $language->flag }}"> <span class="text-uppercase f-18 font-weight-bold">{{ $language->name }}</span>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        <div class="col-sm-8">
